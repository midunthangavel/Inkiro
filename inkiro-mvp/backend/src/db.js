...
if (!SUPABASE_ANON_KEY)         throw new Error('Missing required environment variable: SUPABASE_ANON_KEY or SUPABASE_PUBLISHABLE_KEY');
if (!SUPABASE_SERVICE_ROLE_KEY) throw new Error('Missing required environment variable: SUPABASE_SERVICE_ROLE_KEY or SUPABASE_SECRET_KEY');
